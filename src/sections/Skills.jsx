...
export default function Skills() {
  return (
    <section
      id="skills"
      className="min-h-screen pt-16 pb-16 md:grid md:grid-rows-5 place-items-center overflow-hidden"
    >
      ...
      <div className="px-4 md:px-0 grid gap-5 off-bounds md:absolute md:-translate-x-1/2 md:left-1/2 md:mt-40">
