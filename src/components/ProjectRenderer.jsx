...
export default function ProjectRenderer() {
  ...
  return (
    <>
      ...
      <div className="col-span-2 pl-5 lg:px-0">
        <div className="py-8 h-full flex flex-col gap-4 justify-between">
          ...
          <div className="flex items-center gap-4">
            <div
              className="shadow-xl cursor-pointer p-4 bg-slate-50 hover:bg-white hover:text-purple-700 select-none w-min text-sm font-bold rounded-lg border-slate-600"
              onClick={() => handlePrev()}
            >
              Previous
            </div>
            <div
              className="shadow-xl shadow-purple-200 cursor-pointer p-4 bg-gradient-to-br from-pink-400 to-violet-600 w-fit text-sm select-none font-bold rounded-lg text-white hover:from-pink-800 hover:to-violet-900"
              onClick={() => handleNext()}
            >
              Next Project
            </div>
